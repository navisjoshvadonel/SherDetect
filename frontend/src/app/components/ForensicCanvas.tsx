    ...
    <div className="space-y-3">
      ...
      <div className="neo-card p-3 bg-white flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="w-full md:w-48 space-y-1">
          ...
          <div className="h-2 w-full bg-brutal-bg rounded-full overflow-hidden border-2 border-brutal-black">
            <div
      ...
      <div className="neo-card p-3 bg-white space-y-2.5">
        <div className="flex items-center justify-between border-b-2 border-brutal-black pb-1.5">
          ...
          <span className="text-[9.5px] font-mono font-black bg-brutal-bg px-2 py-0.5 border border-brutal-black rounded">
            {fileName}
          </span>
        </div>

        {/* Bounding Box Visual Area with Scanner Line */}
        <div className="relative h-44 bg-brutal-bg rounded-xl border-2.5 border-brutal-black flex items-center justify-center overflow-hidden shadow-brutal-sm group">
          {/* Animated Radar Scanline */}
          <div className="absolute left-0 right-0 h-1 bg-gradient-to-r from-transparent via-brutal-cyan to-transparent opacity-90 z-20 animate-scanline pointer-events-none" />
