...
-- Note: The service_role bypasses RLS by default, but explicitly granting these ensures 
-- clarity and safety in case settings change. The 'authenticated' check for 'officer' role
-- guarantees that standard customers cannot access sensitive compliance archives.
